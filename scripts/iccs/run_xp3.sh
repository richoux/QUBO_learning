...
do
		...
		for i in {1..100}
		do
				$EXE -f "../spaces/incomplete/alldiff-12_12_$c.txt" -r tmp --benchmark 2> /dev/null 1> /dev/null
		...
		for i in {1..100}
		do
				$EXE -f "../spaces/incomplete/ordered-12_12_$c.txt" -r tmp --benchmark 2> /dev/null 1> /dev/null
		...
		for i in {1..100}
		do
				$EXE -f "../spaces/incomplete/linear_equation-12_12_72_$c.txt" -r tmp --benchmark 2> /dev/null 1> /dev/null
		...
		for i in {1..100}
		do
				$EXE -f "../spaces/incomplete/no_overlap_1D-8_35_3_$c.txt" -r tmp --benchmark 2> /dev/null 1> /dev/null
		...
		for i in {1..100}
		do
				$EXE -f "../spaces/incomplete/channel-12_12_$c.txt" -r tmp --benchmark 2> /dev/null 1> /dev/null
