...
do
		...
		do
				...
				cat training?? > ../results/strong_learners/"$START_DIR"/fixed_training_set/sat/"$constraint-12_12_n$n-training"
				cat test_error_?? > ../results/strong_learners/"$START_DIR"/fixed_training_set/sat/"$constraint-12_12_n$n-test_error"
		...
		cat training?? > ../results/strong_learners/"$START_DIR"/fixed_training_set/sat/"linear_equation-12_12_72_n$n-training"
		cat test_error_?? > ../results/strong_learners/"$START_DIR"/fixed_training_set/sat/"linear_equation-12_12_72_n$n-test_error"
		rm -f test_error_??* tmp??* training??
		...
		cat training?? > ../results/strong_learners/"$START_DIR"/fixed_training_set/sat/"no_overlap_1D-8_35_3_n$n-training"
		cat test_error_?? > ../results/strong_learners/"$START_DIR"/fixed_training_set/sat/"no_overlap_1D-8_35_3_n$n-test_error"
		rm -f test_error_??* tmp??* training??
done
