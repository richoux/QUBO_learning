...
do
		...
		do
				...
				do
						...
						do
								echo -n "Training... "
								$EXE -f "../spaces/incomplete/$constraint-12_12_100.txt" $SOLVER_ARG -w $w -n $n -r tmp01 --benchmark 2> /dev/null 1>> training01&
								$EXE -f "../spaces/incomplete/$constraint-12_12_100.txt" $SOLVER_ARG -w $w -n $n -r tmp02 --benchmark 2> /dev/null 1>> training02&
								$EXE -f "../spaces/incomplete/$constraint-12_12_100.txt" $SOLVER_ARG -w $w -n $n -r tmp03 --benchmark 2> /dev/null 1>> training03&
								$EXE -f "../spaces/incomplete/$constraint-12_12_100.txt" $SOLVER_ARG -w $w -n $n -r tmp04 --benchmark 2> /dev/null 1>> training04&
								$EXE -f "../spaces/incomplete/$constraint-12_12_100.txt" $SOLVER_ARG -w $w -n $n -r tmp05 --benchmark 2> /dev/null 1>> training05&
								$EXE -f "../spaces/incomplete/$constraint-12_12_100.txt" $SOLVER_ARG -w $w -n $n -r tmp06 --benchmark 2> /dev/null 1>> training06&
								$EXE -f "../spaces/incomplete/$constraint-12_12_100.txt" $SOLVER_ARG -w $w -n $n -r tmp07 --benchmark 2> /dev/null 1>> training07&
								$EXE -f "../spaces/incomplete/$constraint-12_12_100.txt" $SOLVER_ARG -w $w -n $n -r tmp08 --benchmark 2> /dev/null 1>> training08&
								wait
						...
						cat training?? > ../results/weak_learners/"$START_DIR"/sampled_training_set/opt/"$constraint-12_12_weak_w$w-n$n-training"
						cat test_error_??_majority > ../results/weak_learners/"$START_DIR"/sampled_training_set/opt/"$constraint-12_12_weak_w$w-n$n-test_error_majority"
				...
				do
						echo -n "Training... "
						$EXE -f "../spaces/incomplete/linear_equation-12_12_72_100.txt" $SOLVER_ARG -w $w -n $n -r tmp01 --benchmark 2> /dev/null 1>> training01&
						$EXE -f "../spaces/incomplete/linear_equation-12_12_72_100.txt" $SOLVER_ARG -w $w -n $n -r tmp02 --benchmark 2> /dev/null 1>> training02&
						$EXE -f "../spaces/incomplete/linear_equation-12_12_72_100.txt" $SOLVER_ARG -w $w -n $n -r tmp03 --benchmark 2> /dev/null 1>> training03&
						$EXE -f "../spaces/incomplete/linear_equation-12_12_72_100.txt" $SOLVER_ARG -w $w -n $n -r tmp04 --benchmark 2> /dev/null 1>> training04&
						$EXE -f "../spaces/incomplete/linear_equation-12_12_72_100.txt" $SOLVER_ARG -w $w -n $n -r tmp05 --benchmark 2> /dev/null 1>> training05&
						$EXE -f "../spaces/incomplete/linear_equation-12_12_72_100.txt" $SOLVER_ARG -w $w -n $n -r tmp06 --benchmark 2> /dev/null 1>> training06&
						$EXE -f "../spaces/incomplete/linear_equation-12_12_72_100.txt" $SOLVER_ARG -w $w -n $n -r tmp07 --benchmark 2> /dev/null 1>> training07&
						$EXE -f "../spaces/incomplete/linear_equation-12_12_72_100.txt" $SOLVER_ARG -w $w -n $n -r tmp08 --benchmark 2> /dev/null 1>> training08&
						wait
						echo -n "Testing Majority... "
				...
				cat training?? > ../results/weak_learners/"$START_DIR"/sampled_training_set/opt/"linear_equation-12_12_72_weak_w$w-n$n-training"
				cat test_error_??_majority > ../results/weak_learners/"$START_DIR"/sampled_training_set/opt/"linear_equation-12_12_72_weak_w$w-n$n-test_error_majority"
				rm -f test_error_??* tmp??* training??
				...
				do
						echo -n "Training... "
						$EXE -f "../spaces/incomplete/no_overlap_1D-8_35_3_100.txt" $SOLVER_ARG -w $w -n $n -r tmp01 --benchmark 2> /dev/null 1>> training01&
						$EXE -f "../spaces/incomplete/no_overlap_1D-8_35_3_100.txt" $SOLVER_ARG -w $w -n $n -r tmp02 --benchmark 2> /dev/null 1>> training02&
						$EXE -f "../spaces/incomplete/no_overlap_1D-8_35_3_100.txt" $SOLVER_ARG -w $w -n $n -r tmp03 --benchmark 2> /dev/null 1>> training03&
						$EXE -f "../spaces/incomplete/no_overlap_1D-8_35_3_100.txt" $SOLVER_ARG -w $w -n $n -r tmp04 --benchmark 2> /dev/null 1>> training04&
						$EXE -f "../spaces/incomplete/no_overlap_1D-8_35_3_100.txt" $SOLVER_ARG -w $w -n $n -r tmp05 --benchmark 2> /dev/null 1>> training05&
						$EXE -f "../spaces/incomplete/no_overlap_1D-8_35_3_100.txt" $SOLVER_ARG -w $w -n $n -r tmp06 --benchmark 2> /dev/null 1>> training06&
						$EXE -f "../spaces/incomplete/no_overlap_1D-8_35_3_100.txt" $SOLVER_ARG -w $w -n $n -r tmp07 --benchmark 2> /dev/null 1>> training07&
						$EXE -f "../spaces/incomplete/no_overlap_1D-8_35_3_100.txt" $SOLVER_ARG -w $w -n $n -r tmp08 --benchmark 2> /dev/null 1>> training08&
						wait
						echo -n "Testing Majority... "
				...
				cat training?? > ../results/weak_learners/"$START_DIR"/sampled_training_set/opt/"no_overlap_1D-8_35_3_weak_w$w-n$n-training"
				cat test_error_??_majority > ../results/weak_learners/"$START_DIR"/sampled_training_set/opt/"no_overlap_1D-8_35_3_weak_w$w-n$n-test_error_majority"
				rm -f test_error_??* tmp??* training??
		done
done
