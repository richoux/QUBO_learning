...
# Directories
OBJDIR=obj
OBJ_block_sat=$(addprefix $(OBJDIR)/,constraint_training_set_block.o builder_block_sat.o learn_qubo_block_sat.o print_qubo.o checks.o encoding.o onehot.o unary.o)
OBJ_block_opt=$(addprefix $(OBJDIR)/,constraint_training_set_block.o builder_block_opt.o learn_qubo_block_opt.o objective_short_expression.o print_qubo.o checks.o encoding.o onehot.o unary.o)
OBJ_weak_block_sat=$(addprefix $(OBJDIR)/,constraint_training_set_block.o builder_block_sat.o weak_learn_qubo_block_sat.o print_qubo.o checks.o encoding.o onehot.o unary.o)
OBJ_weak_block_opt=$(addprefix $(OBJDIR)/,constraint_training_set_block.o builder_block_opt.o weak_learn_qubo_block_opt.o objective_short_expression.o print_qubo.o checks.o encoding.o onehot.o unary.o)
